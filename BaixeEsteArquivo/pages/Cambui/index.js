...
export default function Cambui() {
  const nav = useNavigation();

  const handlePress = () => {
    Linking.openURL('https://maps.app.goo.gl/MfehjvjW3uShLxiS6');
  };
    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollViewContainer} showsVerticalScrollIndicator={false} >
        ...
        <TouchableOpacity onPress={() => nav.goBack()}>
          ...
          <Text style={styles.titu} >Petz Cambui </Text>
        </View>
        <Image
          style={styles.imgdecapa} source={require('../../src/img/cambui.jpg')} />

        <Text style={styles.corpo}>
          A petz oferece tudo o que seu pet precisa: pet shop, produtos pensados para o bem-estar, farmácia e banho e tosa que conta com profissionais especializados
        </Text>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'center', width: '80%', }}>
          ...
          <Text style={styles.filt}> Adoção </Text>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'center', width: '80%', }}>
          ...
          <Text style={styles.filt}> Banho </Text>
