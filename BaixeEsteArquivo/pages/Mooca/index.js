...
export default function Mooca() {
  const nav = useNavigation();

  const handlePress = () => {
    Linking.openURL('https://maps.app.goo.gl/SQy7rrdZmG6j2i1V6');
  };
    ...
    <View style={styles.container}>
      <ScrollView  contentContainerStyle={styles.scrollViewContainer} showsVerticalScrollIndicator={false} >
        ...
        <TouchableOpacity onPress={() => nav.goBack()}>
          ...
          <Text style={styles.titu} >Mooca Plaza Shopping </Text>
        </View>
        <Image
          style={styles.imgdecapa} source={require('../../src/img/mooca.jpg')} />

        <Text style={styles.corpo}>
        O shopping Mooca é o shopping pet friendly mais importante da capital paulista, mais de 50% do público vai acompanhado de seu cachorro. Ele tem um parque no estacionamento e uma praça de alimentação pet friendly ao lado da praça dos humanos. Além disso, há diversos restaurantes que aceitam pets.
        </Text>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'center', width: '80%', }}>
          ...
          <Text style={styles.filt}> Espeço Pet</Text>
