...
export default function NovotelCampos() {

    const nav = useNavigation();


    const handlePress = () => {
        Linking.openURL('https://maps.app.goo.gl/j5ksjFa7MQFfodNw8');
    };
    ...
    return (
        <View style={styles.container}>
            ...
            <MaterialIcons name='arrow-back-ios' size={20} color='#925000' />
                    ...
                    <Text style={styles.titu} >Novotel São José dos Campos</Text>
                </View>
                <Image
                    style={styles.imgdecapa} source={require('../../src/img/campos.jpg')} />

                <Text style={styles.corpo}>
                    É um resort. A pouca distância da capital paulista é apenas um dos motivos que fará você amar passar alguns dias por lá. Ele é um grande hotel, com muitas quartos e atividades esportivos. Bastante procurado por famílias com crianças, recebe pets até 15 quilos.
                </Text>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'center', width: '80%', }}>
                    ...
                    <Text style={styles.filt}> Área de Lazer </Text>
                    <Text style={styles.filt}> Serviço de Quarto </Text>
                ...
                <View style={{ flexDirection: 'row' }}>
                    <View style={{ alignItems: 'center', justifyContent: 'center', textAlign: 'center' }}>
                        <div onClick={() => nav.navigate('ChicoMendes')}>
                            ...
                            <Text style={styles.titu2}> Chico Mendes </Text>
                ...
                < View style={{ flexDirection: 'row' }}>
                    <View style={{ alignItems: 'center', justifyContent: 'center', textAlign: 'center' }}>
                        <div onClick={() => nav.navigate('Campos')}>
                            ...
                            <Text style={styles.titu2}> Paris 6 São José</Text>
                            <Image style={{ width: '80%', height: 20, margin: 10 }} source={require('../../src/img/star.jpg')} />
                        </div>
                    </View>
