...
export default function Iguatemi() {

    const nav = useNavigation();


    const handlePress = () => {
        Linking.openURL('https://maps.app.goo.gl/aVu64BigqXuoyZWp7');
    };
    ...
    return (
        <View style={styles.container}>
            ...
            <MaterialIcons name='arrow-back-ios' size={20} color='#925000' />
                    ...
                    <Text style={styles.titu} >Shopping Iguatemi Esplanada</Text>
                </View>
                <Image
                    style={styles.imgdecapa} source={require('../../src/img/iguatemi.jpg')} />
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'center', width: '80%', }}>
                    ...
                    <Text style={styles.filt}> Shopping</Text>
