...
export default function Periscopio() {

    const nav = useNavigation();


    const handlePress = () => {
        Linking.openURL('https://maps.app.goo.gl/jookfAXJk4LARCEMA');
    };
    ...
    return (
        <View style={styles.container}>
            ...
            <MaterialIcons name='arrow-back-ios' size={20} color='#925000' />
                    ...
                    <Text style={styles.titu} >Praça do Periscópio</Text>
                </View>
                <Image
                    style={styles.imgdecapa} source={require('../../src/img/periscopio.jpg')} />

                <Text style={styles.corpo}>
                    A praça passou a contar com academia ao ar livre, parquinho para crianças, quiosque, sanitários, mesas para jogos, pista de skate e pista de caminhada no seu entorno, além de um gramado e iluminação.
                </Text>
                ...
                <View style={{ flexDirection: 'row', justifyContent:'center', width: '80%', }}>
                    ...
                    <Text style={styles.filt}> Ar Livre </Text>
