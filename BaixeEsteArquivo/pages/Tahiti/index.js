...
export default function Tahiti() {
  const nav = useNavigation();

  const handlePress = () => {
    Linking.openURL('https://maps.app.goo.gl/ZziGTs94MYocxU8C6');
  };
    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollViewContainer} showsVerticalScrollIndicator={false} >
        ...
        <TouchableOpacity onPress={() => nav.goBack()}>
          ...
          <Text style={styles.titu} >Tahiti</Text>
        </View>
        <Image
          style={styles.imgdecapa} source={require('../../src/img/tahiti.jpg')} />

        <Text style={styles.corpo}>
          A área pet fica nas mesinhas do canto lateral (algumas com vista para o mar) e próximas à rua. Ficam pertinho do barco que serve como bar, é de lá que saem os drinks caprichados. Destaque para as caipirinhas.
        </Text>
