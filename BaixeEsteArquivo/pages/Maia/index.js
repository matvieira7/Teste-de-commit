...
export default function Maia() {
  ...
  const handlePress = () => {
    Linking.openURL('https://maps.app.goo.gl/SnSThea2QK6q7eZK9');
  };
    ...
    <View style={styles.container}>
      <ScrollView  contentContainerStyle={styles.scrollViewContainer} showsVerticalScrollIndicator={false} >
        ...
        <TouchableOpacity onPress={() => nav.goBack()}>
          ...
          <Text style={styles.titu} >Pet Park – Bosque Maia </Text>
        </View>
        <Image
          style={styles.imgdecapa} source={require('../../src/img/maia.jpg')} />

        <Text style={styles.corpo}>
        Lugar bom para caminhadas (inclusive com cães) Seguro e agradável. Possui um bosque com trilhas, além de parquinho, pista de skate, quadras poliesportivas e fica próximos a bons bares e restaurantes
        </Text>
