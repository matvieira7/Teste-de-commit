...
export default function Basilico() {
  ...
  const handlePress = () => {
    Linking.openURL('https://maps.app.goo.gl/Zn2pgT8A4qouBuES6');
  };
    ...
    <View style={styles.container}>
      ...
      <ScrollView  contentContainerStyle={styles.scrollViewContainer} showsVerticalScrollIndicator={false} >
        ...
        <TouchableOpacity onPress={() => nav.goBack()}>
          ...
          <Text style={styles.titu} >Seo Basílico </Text>
        </View>
        <Image
          style={styles.imgdecapa} source={require('../../src/img/basilico.jpg')} />

        <Text style={styles.corpo}>
        O Seo Basílico é uma pizzaria na zona leste de São Paulo, mais precisamente na Mooca – que ganhou uma filial em Perdizes. São poucos lugares no salão interno, ainda assim, recebem clientes com pets. E tem a mesa da calçada, para quem preferir. As mesas são bem próximas, então, é mais indicada para pets de porte pequeno e médio.
        </Text>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'center', width: '80%', }}>
          ...
          <Text style={styles.filt}> Praça</Text>
