...
export default function Novembro() {
    ...
    const handlePress = () => {
        Linking.openURL('https://maps.app.goo.gl/ZZK1uuhcRXfUAShg7');
    };
    ...
    return (
        <View style={styles.container}>
            ...
            <MaterialIcons name='arrow-back-ios' size={20} color='#925000' />
                    ...
                    <Text style={styles.titu} >Praça XV de novembro </Text>
                </View>
                <Image
                    style={styles.imgdecapa} source={require('../../src/img/raya.jpg')} />

                <Text style={styles.corpo}>
                    O Parque Curupira é conhecido por suas belas trilhas arborizadas, lagos serenos e espaços abertos amplos, tudo isso em meio à exuberante vegetação. O parque oferece uma atmosfera calma e tranquila, onde você pode desfrutar de momentos agradáveis ao lado do seu animal de estimação.
                </Text>
                ...
                <View style={{ flexDirection: 'row' }}>
                    ...
                    <div onClick={() => nav.navigate('Iguatemi')}>
                        <View style={{ alignItems: 'center', justifyContent: 'center', textAlign: 'center' }}>
                            ...
                            <Text style={styles.titu2}> Shopping Iguatemi </Text>
                            <Image style={{ width: '80%', height: 20, margin: 10 }} source={require('../../src/img/star.jpg')} />
                        </View>
                    </div>
                </View>
