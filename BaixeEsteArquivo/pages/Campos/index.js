...
export default function Campos() {
    ...
    const handlePress = () => {
        Linking.openURL(' https://maps.app.goo.gl/EMiTgPMGUQ7is2556');
    };
    ...
    return (
        <View style={styles.container}>
            ...
            <MaterialIcons name='arrow-back-ios' size={20} color='#925000' />
                    ...
                    <Text style={styles.titu} >Paris 6 Bistrô São José dos Campos</Text>
                </View>
                <Image
                    style={styles.imgdecapa} source={require('../../src/img/campos.jpg')} />

                <Text style={styles.corpo}>
                    O Paris 6 do shopping Vale Sul em São José dos Campos é petfriendly. Como o shopping só permite pets no colo, temos uma limitação de porte. Inspirada em Paris, a casa oferece massas, carnes, sobremesas e muito mais em um ambiente clássico e aconchegante
                </Text>
