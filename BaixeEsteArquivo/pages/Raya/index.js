...
export default function Raya() {
    ...
    const handlePress = () => {
        Linking.openURL('https://maps.app.goo.gl/T4Ho33FJC49MaNMi8');
    };
    ...
    return (
        <View style={styles.container}>
            ...
            <MaterialIcons name='arrow-back-ios' size={20} color='#925000' />
                    ...
                    <Text style={styles.titu} >Parque Dr. Luis Carlos Raya </Text>
                </View>
                <Image
                    style={styles.imgdecapa} source={require('../../src/img/raya.jpg')} />

                <Text style={styles.corpo}>
                    Um ambiente natural com trilhas e espaços para você e seu pet se exercitarem.
                </Text>
